...
// get coin plans
router.get("/",diamondPlanController.index);

// get purchase plan history
router.get("/history", checkAccessWithKey(), diamondPlanController.purchaseHistory);

//create coin plan
router.post("/C",diamondPlanController.store);

//create coin plan
router.get("/isTopToggle", diamondPlanController.isTopToggle);
...
//delete coin plan
router.delete("/:planId",diamondPlanController.destroy);
